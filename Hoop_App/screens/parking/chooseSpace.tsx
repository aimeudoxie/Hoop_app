...
const ChooseSpace: React.FC = () => {
    ...
    const [fontsLoaded] = useFonts({
        'Avenir': require('../../assets/Avemir-Font/avenir_ff/AvenirLTStd-Book.otf'),
        'Avenirbold': require('../../assets/Avemir-Font/avenir_ff/AvenirLTStd-Black.otf'),
        'Avenirroman': require('../../assets/Avemir-Font/avenir_ff/AvenirLTStd-Roman.otf'),
    });
